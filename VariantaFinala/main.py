...
class WhoAreYou(Screen):
    def check_login(self, username_input, password_input):
        ...
        if username_input in LogIn and password_input == LogIn[username_input]:    #if the login credentials exist
            ...
            wrong_credentials = Popup(title="Error", content=Label(text="Invalid e-mail or password!",color='green'), background='images/green.png', title_color=(51/255,102/255,0,1),
                                      title_size=25,
                                      size_hint=(0.5, 0.5))
