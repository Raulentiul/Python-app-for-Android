...
from kivy_garden.mapview import MapView, MapSource, MapMarker, MapMarkerPopup, MapLayer
...
##############        aici am ramas
        ...
        def load_markers():
                ...
                for uid, marker_data in marker_info.items():
                    if marker_data["lat"] == instance.marker.lat and marker_data["lon"] == instance.marker.lon:
                        ...
                        if marker_data["user"] == UserName:
                            ...
                            not_allowed_popup=Popup(title="Error",content=(Label(text="You didn`t create this activity.\nYou cannot delete it!",color=(133/255, 160/255, 129/255, 1))),title_color=(133/255, 160/255, 129/255, 1),     #we set what to pop up when we click the saved marker
                                      title_size=30,
                                      size_hint=(0.8, 0.5),
            ...
            def completed(marker):
                ...
                global UserName
                global last_completion_time
                reward_label = Label(text='You won {points_reward} points', color=(133/255, 160/255, 129/255, 1),
                ...
                reward_popup = Popup(title="Congratulations " + str(UserName) + "!",
                                     ...
                                     title_color=(133/255, 160/255, 129/255, 1),
                                     # we set what to pop up when we click the saved marker
                                     title_size=20,
                                     size_hint=(0.8, 0.5),
                    ...
                    if marker_data["lat"] == instance.marker.lat and marker_data["lon"] == instance.marker.lon:
                        ...
                        if marker_data["user"] != UserName:
                            ...
                            not_allowed1_popup = Popup(title="Error", content=(Label(
                                ...
                                color=(133/255, 160/255, 129/255, 1))), title_color=(133/255, 160/255, 129/255, 1),
                                                       # we set what to pop up when we click the saved marker
                                                       title_size=30,
                                                       size_hint=(.8, 0.5),
            ...
            for uid, marker_data in marker_info.items():
                ...
                # Create a Label for displaying text
                label = Label(text=marker_data["description"], color=(133/255, 160/255, 129/255, 1))

                marker_popup_layout.add_widget(label)

                button_layout = BoxLayout(orientation='horizontal', size_hint=(1, 0.1))
                delete_button = Button(text='Delete', size_hint=(0.2, 1), background_color = (133/255, 160/255, 129/255, 1))

                complete_button = Button(text='Done', size_hint=(0.2, 1),background_color = (133/255, 160/255, 129/255, 1))
            ...
            if instance.collide_point(
                ...
                def on_btn_click(instance):  # in this function we say what will happen when we will click the button
                    ...
                    savebtn = Button(text="Save",
                                     ...
                                     size=(100, 15),
                                     background_normal=(""),
                                     background_color=(165 / 255, 186 / 255, 167 / 255, 1),
                                     font_size=20)
...
class Profile(Screen):
    def __init__(self, **kwargs):
        ...
        logout_button = Button(text='Log Out', pos_hint={'center_x': 0.9, 'center_y': 0.9}, size_hint=(0.2, 0.1),
                             background_color=(1, 1, 1, 0.03), color='black')

        rewards_button = Button(text='Rewards', pos_hint={'center_x': 0.1, 'center_y': 0.9}, size_hint=(0.2, 0.1),
                             background_color=(1, 1, 1, 0.03), color='black')
...
class Rewards(Screen):
    def __init__(self, **kwargs):
        ...
        back_button = Button(text='Back',pos_hint={'center_x': 0.9, 'center_y': 0.9}, size_hint=(0.2, 0.1), background_color=(1, 1, 1, 0.03), color='black')
    ...
    def add_reward(self, name, points):
        ...
        button = Button(text=f"Unlock ({points} points)", size_hint_x=None, width=200,
                        background_color=(185 / 255, 206 / 255, 163 / 255, 1), background_normal=(""))
    ...
    def on_unlock(self, points):
        ...
        if total_user_points >= points:
            ...
            popup = Popup(title="Reward unlocked!", content=(Label(text="Your reward code is ...", color='green')),
...
class List(Map,Screen):
    def __init__(self, **kwargs):
        ...
        def add_marker_to_list(user,lat,lon,description):
            ...
            label=Label(text='Created by: '+user+'\n'+description,halign='center', valign='middle')
            elements_box.add_widget(label)

            link_button=Button(text='Show me.', size_hint=(.5,.5))
            ######################
